// src/lib/jd-parser.js
import OpenAI from 'openai';
import { storeJD, getJD, hasFreshJD } from '../shared/storage.js';
...
// Main export function: parse and cache JD
export async function parseAndCacheJD(jdText) {
